...
public class PalindromicSubstrings {
     ...
     * 解法是使用中心扩展法，遍历字符串中的每个字符，以每个字符为中心向两边扩展，分别检查奇数长度和偶数长度的回文子串。具体实现时，使用两个指针left和right，分别指向当前中心字符的左右两个字符。如果左右字符相等，则将回文子串的个数加一，并将left左移，right右移，继续检查下一个字符。直到左右字符不相等或超出字符串边界为止。
     * <p>
     * 算法复杂度分析：
     * <p>
